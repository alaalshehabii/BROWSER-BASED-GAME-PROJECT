...
const player = { w: 32, h: 32, x: canvas.width / 2 - 16, y: START_PLATFORM_Y - 32, vy: 0, prevY: 0 };
...
/* Clickable hitbox for START text on canvas */
...
addEventListener("keydown", (e) => {
  const kRaw = e.key;
  if (kRaw === "ArrowUp" || kRaw === "ArrowDown" || kRaw === "ArrowLeft" || kRaw === "ArrowRight" || kRaw === " ") {
...
function updateHUD(){ $score.textContent = String(score); $best.textContent = String(best); }
